...
public class FeatureLangAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected FeatureLangSwitch<Adapter> modelSwitch =
    new FeatureLangSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseUpdateAttributeDatatype(UpdateAttributeDatatype object)
      {
        return createUpdateAttributeDatatypeAdapter();
      }
      @Override
      public Adapter caseUpdateAttributeIdentifier(UpdateAttributeIdentifier object)
      {
        return createUpdateAttributeIdentifierAdapter();
      }
      @Override
      public Adapter caseUpdateAttributeValue(UpdateAttributeValue object)
      {
        return createUpdateAttributeValueAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link de.tud.st.featurelang.featureLang.UpdateAttributeDatatype <em>Update Attribute Datatype</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createUpdateAttributeDatatypeAdapter()
  {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link de.tud.st.featurelang.featureLang.UpdateAttributeIdentifier <em>Update Attribute Identifier</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createUpdateAttributeIdentifierAdapter()
  {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link de.tud.st.featurelang.featureLang.UpdateAttributeValue <em>Update Attribute Value</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createUpdateAttributeValueAdapter()
  {
    return null;
  }
  ...
  /**
   * Creates a new adapter for an object of class '{@link de.tud.st.featurelang.featureLang.Identifier <em>Identifier</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
