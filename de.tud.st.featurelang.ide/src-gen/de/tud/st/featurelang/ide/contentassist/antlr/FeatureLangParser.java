...
public class FeatureLangParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, FeatureLangGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getCompositionActionAccess().getAlternatives_0(), "rule__CompositionAction__Alternatives_0");
			...
			builder.put(grammarAccess.getCompositionActionAccess().getGroup(), "rule__CompositionAction__Group__0");
			...
			builder.put(grammarAccess.getAssociationActionAccess().getTargetAssignment_4(), "rule__AssociationAction__TargetAssignment_4");
			builder.put(grammarAccess.getAssociationActionAccess().getRelationAssignment_6(), "rule__AssociationAction__RelationAssignment_6");
			builder.put(grammarAccess.getInheritanceActionAccess().getParentAssignment_2(), "rule__InheritanceAction__ParentAssignment_2");
			builder.put(grammarAccess.getCompositionActionAccess().getTargetAssignment_1(), "rule__CompositionAction__TargetAssignment_1");
			builder.put(grammarAccess.getCompositionActionAccess().getRelationAssignment_3(), "rule__CompositionAction__RelationAssignment_3");
